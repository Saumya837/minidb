...
int main(){
    ...
    std::string sql = "SELECT department, salary FROM employees LEFT JOIN departments ON employees.dept_id = departments.id WHERE salary < 3000.50 OR salary >= 10000.40 limit 10;";
