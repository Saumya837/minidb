...
void test_basic_lifecycle() {
    ...
    //assert commited xid no longer in active set
    assert(snap_next_xid.active_xids.count(first_xid) == 0);

    //assert aborted xid longer in active set
